...
create policy if not exists "anon can read stores"
on public.stores for select
to anon
using (true);

create policy if not exists "anon can read locations"
on public.locations for select
to anon
using (true);

create policy if not exists "anon can read customers"
on public.customers for select
to anon
using (true);

create policy if not exists "anon can create customers"
on public.customers for insert
to anon
with check (true);

create policy if not exists "anon can read service orders"
on public.service_orders for select
to anon
using (true);

create policy if not exists "anon can create service orders"
on public.service_orders for insert
to anon
with check (true);

create policy if not exists "anon can read products"
on public.products for select
to anon
using (true);

create policy if not exists "anon can create products"
on public.products for insert
to anon
with check (true);

create policy if not exists "anon can update products"
on public.products for update
to anon
using (true)
with check (true);

create policy if not exists "anon can read inventory"
on public.inventory for select
to anon
using (true);

create policy if not exists "anon can manage inventory"
on public.inventory for all
to anon
using (true)
with check (true);

create policy if not exists "anon can read stock movements"
on public.stock_movements for select
to anon
using (true);

create policy if not exists "anon can create stock movements"
on public.stock_movements for insert
to anon
with check (true);

create policy if not exists "anon can read store requests"
on public.store_requests for select
to anon
using (true);

create policy if not exists "anon can create store requests"
on public.store_requests for insert
to anon
with check (true);

create policy if not exists "anon can read store request items"
on public.store_request_items for select
to anon
using (true);

create policy if not exists "anon can create store request items"
